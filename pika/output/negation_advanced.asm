        ...
        Add                                    %% test2
        LoadC                                  
        JumpTrue     -print-boolean-230-true   
        Label        basicBlock-5              
        PushD        $boolean-false-string     
        Jump         -print-boolean-230-join   
        Label        basicBlock-6              
        Label        -print-boolean-230-true   
        PushD        $boolean-true-string      
        Label        basicBlock-7              
        Label        -print-boolean-230-join   
        PushD        $print-format-boolean     
        Printf                                 
        ...
        Add                                    %% test2
        LoadC                                  
        JumpTrue     -print-boolean-232-true   
        Label        basicBlock-11             
        PushD        $boolean-false-string     
        Jump         -print-boolean-232-join   
        Label        basicBlock-12             
        Label        -print-boolean-232-true   
        PushD        $boolean-true-string      
        Label        basicBlock-13             
        Label        -print-boolean-232-join   
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-newline     
        Printf                                 
